...
var spiderWalkingKeyframes = [
    new Keyframe().add(0).add(-10, -20, -10, 10).add(-10, 10, -10, -20).add(20, 10, 70, 20).add(70, 20, 20, 10),
    new Keyframe().add(0).add(10, -10, -20, -10).add(-20, -10, 10, -10).add(20, 20, 10, 70).add(10, 70, 20, 20),
    new Keyframe().add(0).add(-10, 10, -10, -20).add(-10, -20, -10, 10).add(70, 20, 20, 10).add(20, 10, 70, 20),
    new Keyframe().add(0).add(-20, -10, 10, -10).add(10, -10, -20, -10).add(10, 70, 20, 20).add(20, 20, 10, 70)
];

var spiderFallingKeyframes = [
    new Keyframe().add(0).add(7, 3, -1, -5).add(5, 1, -3, -7).add(-14, -6, 2, 10).add(-10, -2, 6, 14),
    new Keyframe().add(0).add(30, 10, -30, -20).add(30, 40, -10, -35).add(-50, -90, 40, 20).add(-50, -40, 70, 30)
];
